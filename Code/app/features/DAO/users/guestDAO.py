...
class GuestDAO:
    ...
    """ Classse Data Access Object de la classe Guest """
    ...
    def addAccounttoData(self):
        ...
        # Etape 2 : on crée un curseur qui va nous
        #  permettre d'exécuter la requête
        curseur = connexion.cursor()
        # Etape 3 : on crée un bloc try/except
        try:
            # Etape 4 : on exécute notre requête SQL. 
            # Les %s vont être remplacé par les valeurs passé dans la seconde partie du execute
            curseur.execute(
